      ...
      <Container>
        <Row>
          <Col md={8} className="home-about-description">
            ...
            Born in Bengaluru, India - The Silicon Valley of India, passionate about tech, solving modern problems & anything IT & Data! 
              ...
              <i>
                <b className="purple">Data Science & Analytics, ETL & Data Engineering, Cloud based services, Project Management & Consulting. </b>
                {" "}
                <b className="purple">
             ...
             I learn by working on projects
              leveraging <i> <b className="purple">
                  {" "}
                  Datasets, Python Libraries & Frameworks
                </b>
              </i>
              &nbsp; , and
              
              explore trending tools for <i><b className="purple"> ML & Software Development.  <br></br>
                </b> 
